...
import { IBook } from "@/types/bookResponse";
...
const cardData: CardData[] = [
  {
    ...
    description:
      "A mystical forest bathed in crimson light, home to ancient spirits and magical creatures.",
    category: "Nature",
  },
  {
    id: 2,
    ...
    description:
      "Towering peaks shrouded in ethereal mist, where the air is pure and the views are endless.",
    category: "Landscape",
  },
  {
    id: 3,
    ...
    description:
      "Mysterious islands suspended in the sky, defying gravity with their otherworldly beauty.",
    category: "Fantasy",
  },
  {
    id: 4,
    ...
    title: "Crystal Cave",
    description:
      "A hidden cavern filled with luminescent crystals that glow with an inner light.",
  ...
  },
  {
    ...
    title: "Sunset Peaks",
    description:
      "Golden hour transforms these majestic mountains into a painter's dream canvas.",
    category: "Landscape",
  },
  {
    id: 6,
    ...
    title: "Night Sky",
    description:
      "A celestial tapestry of stars and galaxies stretching across the infinite cosmos.",
    category: "Space",
  },
  {
    id: 7,
    ...
    title: "Ancient Ruins",
    description:
      "Time-worn structures that whisper secrets of civilizations long forgotten.",
    category: "History",
  },
  {
    id: 8,
    ...
    title: "Magical Tree",
    description:
      "A sentient tree with branches that reach toward the heavens, pulsing with magical energy.",
    category: "Fantasy",
  },
  {
    id: 9,
    ...
    description:
      "Waters that mirror the night sky, creating a perfect reflection of the universe above.",
    category: "Nature",
  },
];
...
export default function Herocarousel() {
  ...
  return (
    <section
      className={`w-full md:w-100 lg:w-200 flex-col items-center justify-center font-sans overflow-hidden ${
        isFullscreen ? "fixed inset-0 z-50 bg-black" : ""
      }`}
    >
      <div
        className={`${isFullscreen ? "w-full h-full" : "w-full mx-auto p-4"}`}
        onMouseEnter={() => setIsPaused(true)}
        onMouseLeave={() => setIsPaused(false)}
      >
        <div
          className={`relative flex w-full flex-col rounded-3xl border border-white/10 dark:border-white/10  dark:bg-neutral-900 p-4 pt-6 md:p-6 ${
            isFullscreen ? "h-full" : ""
          }`}
        >
          ...
          <div
            className={`relative w-full flex items-center justify-center overflow-hidden ${
              isFullscreen ? "flex-1" : "h-[280px] md:h-[400px]"
            }`}
          >
            <motion.div
                    ...
                    >
                      <img
                        ...
                        onError={(e) => {
                          ...
                          target.onerror = null;
                          target.src =
                            "https://placehold.co/64x48/1e1e1e/ffffff?text=IMG";
                        }}
                      />
                    </button>
                  ))}
